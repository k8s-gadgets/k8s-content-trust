...
{{- define "metadata.database.signer.deploy.url" -}}
mysql://signer@tcp({{ .Values.notaryDB.svc.name }}:{{ .Values.notaryDB.svc.port }})/notarysigner
{{- end -}}

{{- define "metadata.database.signer.cm.url" -}}
signer@tcp({{ .Values.notaryDB.svc.name }}:{{ .Values.notaryDB.svc.port }})/notarysigner?parseTime=True
{{- end -}}



{{- define "metadata.database.server.deploy.url" -}}
mysql://server@tcp({{ .Values.notaryDB.svc.name }}:{{ .Values.notaryDB.svc.port }})/notaryserver
{{- end -}}

{{- define "metadata.database.server.cm.url" -}}
server@tcp({{ .Values.notaryDB.svc.name }}:{{ .Values.notaryDB.svc.port }})/notaryserver?parseTime=True
{{- end -}}
